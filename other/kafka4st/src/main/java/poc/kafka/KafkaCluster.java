...
public class KafkaCluster {
    ...
    public KafkaCluster(String zkConnection) {
        this(zkConnection, new Properties());
    }

    public KafkaCluster(String zkConnection, Properties baseProperties) {
        this(zkConnection, baseProperties, Collections.singletonList(-1));
    }

    public KafkaCluster(String zkConnection, Properties baseProperties, List<Integer> ports) {
    ...
    public void startup() {
        for (int i = 0; i < ports.size(); i++) {
            ...
            File logDir = Util.constructTempDir("kafka-local");
